...
const HomeTab = ({ selectedTab = 'Transactions', onTabChange = () => {} }) => {
  const [isToggled, setIsToggled] = useState(selectedTab === 'Requests');
    ...
    if (containerWidth > 0) {
      Animated.parallel([
        Animated.spring(translateX, {
          toValue: isToggled ? containerWidth / 2 - 8 : 0, // Adjust translateX for -8 offset on Requests
          speed: 12,
          bounciness: 8,
  ...
  const toggleButton = useCallback(() => {
    const newTab = isToggled ? 'Transactions' : 'Requests';
      ...
      >
        ...
        >
          <Text style={styles.sideText}>
            {isToggled ? 'Transactions' : 'Requests'}
          </Text>
        </Animated.View>
        <Animated.View
          style={[
      ...
      >
        ...
        >
          <Text style={styles.buttonText}>
            {isToggled ? 'Requests' : 'Transactions'}
          </Text>
        </TouchableOpacity>
      </Animated.View>
    </View>
